...
public class SimpleRecord {
    ...
    public static class SimpleRecordBuilder {
        ...
        public SimpleRecordBuilder id(String id) {
            this.id = id;
            return this;
        }

        public SimpleRecordBuilder trainFilePath(String trainFilePath) {
            this.trainFilePath = trainFilePath;
            return this;
        }

        public SimpleRecordBuilder testFilePath(String testFilePath) {
            this.testFilePath = testFilePath;
            return this;
        }
